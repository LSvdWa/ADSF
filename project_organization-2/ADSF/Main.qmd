...
models <- list(
 ...
 mod6 = lm(Glucose ~ Age + Insulin + BMI, 
  ...
  model4 = lm(Glucose ~ Age + Insulin + BMI + BloodPressure,
             data = dataRDS),
 model35 =lm(Glucose ~ Insulin * Age + BloodPressure, data = dataRDS), # AIC=3612.325, BIC=3636.168
model36 =lm(Glucose ~ Insulin * Age + BloodPressure + BMI, data = dataRDS) # AIC=3612.325, BIC=3636.168
