---
title: "Prediction of glucose using linear regression"
format: 
  html: 
    toc: true
    toc-location: left
...
To preprocess the data we categorized the BMI into four categories, being underweight, healthy, overweight and obese. We removed missing values from Glucose, BMI, SkinThickness and Insulin.  
