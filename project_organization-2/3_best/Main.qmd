...
3.  Predictors are strictly exogenous:\
    - i.e. the predictors do not corrolate with the errors
4.  The errors have constant, finite variance
5.  Errors are uncorrolated
6.  Errors are normally distributed

Assumptions 3-6 can be shown if:

![](images/clipboard-811635372.png)

```{r}
cov(predict(model3),errors)

hist(errors,
       main = paste("Histogram of"),
       xlab = paste("Values of"))
```
