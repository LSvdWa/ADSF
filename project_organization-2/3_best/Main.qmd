...
3.  Predictors are strictly exogenous:
    -   i.e. the predictors do not correlate with the errors
4.  The errors have constant, finite variance
5.  Errors are uncorrelated
6.  Errors are normally distributed

Assumptions 3-6 can be shown if: $\varepsilon \stackrel{idd}{\sim} N(O,\sigma^2)$
